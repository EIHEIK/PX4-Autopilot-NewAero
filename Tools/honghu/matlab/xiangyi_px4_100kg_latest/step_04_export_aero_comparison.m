...
save(fullfile(aeroOutputDir, "dual_source_aero_results.mat"), ...
    "frameChecks", "coefficientMetrics", "pluginMetrics", ...
    "engineMetrics", "sensitivityMetrics", "inertia100FRD", "-v7");

summary = struct;
summary.GeneratedBy = "MATLAB R2025a sequential scripts";
summary.MassKg = massKg;
summary.InertiaFRD = inertia100FRD;
summary.CoordinateContract = ...
    "Xiangyi RFU -> FRD; PX4 body FRD and navigation NED";
summary.XiangyiThrottleMapping = "min(1.25 * FW_Thr / 100, 1)";
summary.ReactionTorque = "+Mx_FRD conditional Xiangyi/100kg test assumption";
...
fileID = fopen(fullfile(aeroOutputDir, ...
    "dual_source_aero_summary.json"), "w", "n", "UTF-8");
